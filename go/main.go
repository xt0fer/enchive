...
const (
	...
	ENCHIVE_FORMAT_VERSION = 3

	ENCHIVE_FILE_EXTENSION           = ".enchive"
	ENCHIVE_KEY_DERIVE_ITERATIONS    = 25 //* 32MB */
	ENCHIVE_SECKEY_DERIVE_ITERATIONS = 29 //* 512MB */

	ENCHIVE_OPTION_AGENT             = 1
	ENCHIVE_AGENT_TIMEOUT            = 900 //* 15 minutes */
	ENCHIVE_AGENT_DEFAULT_ENABLED    = 0
	ENCHIVE_PINENTRY_DEFAULT         = "pinentry"
